      ...
      <div class="row py-3">
         ...
         <!-- class="modal-dialog modal-xl" -->
          ...
          <div class="form-row">
              ...
              <div class=" col-lg-12 col-md-8 mb-4 card border-0 shadow"  >
              <!--<div class="modal-content" >-->
              <div class="form-row">
                    ...
                    <div class="form-row">
                                                ...
                                                <select class="form-control" name="collector"   required>
                                                  <option value="">Choose a collector...</option>
                                                   <?php while($row2= $result2->fetch_assoc()){ 
                                                    ...
                                                    $result5 = $conn->query($sql5);
                                                    $row5= $result5->fetch_assoc();
                                                    if($row5["username"]== $row2["username"] ){
                                                    ?>
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-md-10 mb-3">
                            ...
                            <input type="date" name="date"id="disabledTextInput" class="form-control" placeholder="Proposed date...">
