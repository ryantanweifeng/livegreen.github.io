...
<body >
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      <a class="navbar-brand" style="color:black;" href="index.html" >LiveGreen</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" style="color:black;" href="index.html" data-toggle="modal" data-target="#addMaterial2">
            Change<br>Information</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container  shadow p-3 mb-5 bg-white rounded" id="register"  >
        <h2 class="navbar-brand" style="padding-left:3%;">Welcome, <?php echo $_SESSION['username']; ?>!<br>
        <br>Full Name: <?php echo $_SESSION['fullname']; ?>
        <br>Total Point: <?php echo $_SESSION['totalPoints']; ?></h2>
  ...
  <!-- Material design -->
    ...
    <div class="container  shadow p-3 mb-5 bg-white rounded" id="register" >
                            ...
                            <tbody>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Update Person Information</h5>
                                    </div>


                                    <div class= "modal-body">
                                        <form class="needs-validation" method="POST" action="/Assignment2/assets/php/updateMaterialInfo.php" novalidate>
        ...
        <a href="collectorLogin.php"><button type="button" class="btn  btn-outline-dark" data-toggle="modal">
                Back
        </button></a>            
...
<!-- End of Material design -->
        ...
        <!-- Add new material -->
        <div class="modal fade"  id="addMaterial2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class= "modal-body">
                <form class="needs-validation" method="POST" action="/Assignment2/assets/php/updatePersonInfo.php" >
